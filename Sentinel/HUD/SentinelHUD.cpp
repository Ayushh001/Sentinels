...
void ASentinelHUD::BeginPlay()
{
	Super::BeginPlay();
}

void ASentinelHUD::AddCharacterOverlay()
{
...
void ASentinelHUD::AddAnnouncement()
{
	APlayerController* PlayerController = GetOwningPlayerController();
...
void ASentinelHUD::AddElimAnnouncement(FString Attacker, FString Victim)
{
...
void ASentinelHUD::ElimAnnouncementTimerFinished(UElimAnnouncement* MsgToRemove)
{
	if (MsgToRemove)
	{
...
void ASentinelHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCentre, FVector2D Spread, FLinearColor CrosshairsColor)
{
